...
<html>
	...
	// 2. DB에 접속하는 코드
		...
		PreparedStatement selectListStmt = conn.prepareStatement(BASE_QUERY+" ORDER BY dm.dept_no ASC LIMIT ?, ?");
		selectListStmt.setInt(1, listBeginIndex);
		selectListStmt.setInt(2, listPageSize);
		
		PreparedStatement selectListSizeStmt = conn.prepareStatement("SELECT COUNT(*) FROM dept_manager");
